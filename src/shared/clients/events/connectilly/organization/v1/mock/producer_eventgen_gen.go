...
// Package mock_organizationv1 is a generated GoMock package.
package mock_organizationv1

import (
	context "context"
	reflect "reflect"

	organizationv1 "github.com/Connectilly/connectilly/src/shared/clients/events/connectilly/organization/v1"
...
func (m *MockProducer) Produce(ctx context.Context, key string, event organizationv1.OrganizationEvent) error {
	m.ctrl.T.Helper()
