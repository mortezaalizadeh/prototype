...
type OrganizationFunc func(context.Context, *entities.OrganizationMutation) (entities.Value, error)

// Mutate calls f(ctx, m).
func (f OrganizationFunc) Mutate(ctx context.Context, m entities.Mutation) (entities.Value, error) {
	if mv, ok := m.(*entities.OrganizationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *entities.OrganizationMutation", m)
}
